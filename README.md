...
A Debian 13 install will need [Python six](https://pypi.org/project/six/) adding, but Trixie - the Raspberry Pi Debian 13 - should not be used on an early Pi. Stick to Bookworm - Debian 12 - for those.
